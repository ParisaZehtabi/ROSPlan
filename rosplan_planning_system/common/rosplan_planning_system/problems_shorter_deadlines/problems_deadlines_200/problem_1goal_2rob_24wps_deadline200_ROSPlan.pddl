...
(:init
    ...
    ;; (at 131.776 (not (delivery_destination wp0)))
    ;; (at 131.776 (not (delivery_destination wp1)))
    ;; (at 131.776 (not (delivery_destination wp2)))
    ;; (at 131.776 (not (delivery_destination wp3)))
