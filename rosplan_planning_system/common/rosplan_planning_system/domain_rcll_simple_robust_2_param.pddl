...
(:durative-action produce_base_1
    ...
    :synth-parameters (?refueling_rate_1)
    ...
    :effect (and
        ...
        (at end (decrease (charge_level ?r) ?refueling_rate_1))
        )
)
...
(:durative-action produce_base_2
    :parameters (?r - robot ?bs - base_station ?o - order)
    :synth-parameters (?refueling_rate_2)
    ...
    :effect (and
        ...
        (at end (decrease (charge_level ?r) ?refueling_rate_2))
        )
)
