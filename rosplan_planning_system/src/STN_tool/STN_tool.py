    ...
    def esterelPlanCallback(self, input_esterel_plan):
        ...
        # raise flag indicating that msg has been received
            ...
            for edge in input_esterel_plan.edges:
                ...
                if parameter_count < self.max_parameters and edge.edge_type == 1 and (input_esterel_plan.nodes[edge.source_ids[0]].action.name.startswith("collect") or input_esterel_plan.nodes[edge.source_ids[0]].action.name.startswith("produce_base")):
